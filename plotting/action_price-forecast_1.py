...
temperature = np.load(
    "runs/price-forecast/DQN_piecewise_quadratic_18_w1000pd5_1/DQN_piecewise_quadratic_18_w1000pd5_1_temp.npy"
)
price = np.load(
    "runs/price-forecast/DQN_piecewise_quadratic_18_w1000pd5_1/DQN_piecewise_quadratic_18_w1000pd5_1_price.npy"
)
# Tamb = np.load("data/Tamb_Csb.npy")
actions = np.load(
    "runs/price-forecast/DQN_piecewise_quadratic_18_w1000pd5_1/DQN_piecewise_quadratic_18_w1000pd5_1_actions.npy"
)
...
fig.savefig("plotting/plots/action_price-forecast_1.pdf", format="pdf")
