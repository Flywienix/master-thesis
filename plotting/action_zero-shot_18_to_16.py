...
price = np.load(
    "runs/transfer-learning/zero-shot/DQN_18_to_16_zs/DQN_piecewise_linear_18_w1000pd5_2_price.npy"
)
# Tamb = np.load("data/Tamb_Csb.npy")
actions = np.load(
    "runs/transfer-learning/zero-shot/DQN_18_to_16_zs/DQN_piecewise_linear_18_w1000pd5_2_actions.npy"
)
...
fig.savefig("plotting/plots/action_zero-shot_18_to_16.pdf", format="pdf")
