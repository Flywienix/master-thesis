...
# price = np.load(
#     "runs/method-comparison/DQN_quadratic_18_w1d5_3/DQN_quadratic_18_w1d5_3_price.npy"
# )
Tamb = np.load("data/Tamb_Csb.npy")
actions = np.load(
    "runs/method-comparison/DQN_quadratic_18_w1d5_3/DQN_quadratic_18_w1d5_3_actions.npy"
)
...
ax[0].plot([21] * duration, alpha=0.2, color=color_palette[2])
...
fig.savefig("plotting/plots/action_method-comparison_3.pdf", format="pdf")
